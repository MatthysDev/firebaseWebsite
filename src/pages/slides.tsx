...
const SlidesPage = () => {
  return (
    <Layout pageTitle={"Slides"}>
      <div className="sm:flex-col md:flex md:flex-row m-auto h-2/3 m-10 ">
        <div className="m-auto h-2/3 sm:w-5/6 md:w-1/2 ">
          <p className="pt-4 text-left pl-2 pb-4 text-gray-400 hover:text-purple-400 text-2xl">
            <a
      ...
      <div className="sm:flex-col md:flex md:flex-row m-auto h-2/3 mt-10 ">
