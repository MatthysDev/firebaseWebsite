...
const Sidebar = () => (
  <div className=" p-8 md:m-0 sm:w-full lg:w-72 h-screen  bg-black md:border-r-4 lg:border-green-700 lg:space-y-8 space-y-8 border-b-4 lg:border-b-0 border-green-700">
