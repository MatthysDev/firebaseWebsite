...
export default function Airtable() {
  ...
  return (
    <>
      {!isLoaded ? (
        <img
          className="m-auto mt-8 w-2/3 border-4 rounded-lg  border-purple-400"
          src={logo}
      ...
      <iframe
        className={
          isLoaded
            ? "w-7/8 airtable-embed bg-transparent lg:w-2/3 m-auto mt-12 border-4 rounded-lg  border-purple-400"
            : "hide"
        }
        onLoad={handleLoad}
